...
parser = argparse.ArgumentParser(description="Text Classification with N-gram TF-IDF Vectorization using SVM")
...
clf = SVC(kernel='linear', random_state=0)  # Using a linear kernel for interpretability
